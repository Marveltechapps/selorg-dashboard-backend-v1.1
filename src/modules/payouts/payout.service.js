...
exports.getRiderPayouts = exports.getPayoutStatement = exports.getPayoutById = exports.createPayoutRequest = exports.calculateEarnings = void 0;
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        case 0:
          ...
          return _context3.a(2, _Payout.Payout.find({
            riderId: riderId
          }).sort({
            requestedAt: -1
          }).limit(limit));
