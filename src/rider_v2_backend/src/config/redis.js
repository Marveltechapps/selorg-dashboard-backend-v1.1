...
exports.getRedisClient = exports.disconnectRedis = void 0;
...
var getRedisClient = exports.getRedisClient = function getRedisClient() {
  ...
  if (!redisClient) {
    ...
    redisClient = new _ioredis["default"](redisUrl, {
...
var disconnectRedis = exports.disconnectRedis = /*#__PURE__*/function () {
  ...
  return function disconnectRedis() {
