...
router.get('/', requirePermission('view_users'), asyncHandler(userController.getUsers));
router.get('/:id', requirePermission('view_users'), asyncHandler(userController.getUserById));
